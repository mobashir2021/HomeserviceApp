...
@Component({
  selector: 'app-completedleads',
  templateUrl: './completedleads.page.html',
  styleUrls: ['./completedleads.page.scss'],
})
export class CompletedleadsPage implements OnInit {

  Partid : number;
  apiUrl: string = 'http://www.hmsdatamanagement.co.in/api/ServiceApi/GetCompletedLeads';
  items: any;
  result : JSON;
